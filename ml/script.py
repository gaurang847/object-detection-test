...
# constants
YOLO_DIR = os.path.sep.join([os.getcwd(), 'ml' , 'yolo-coco'])
IMAGE_DIR = os.path.sep.join([os.getcwd(), 'uploads'])
OUTPUT_DIR = os.path.sep.join([os.getcwd(), 'output'])
RESPONSE = {'detection': []}
...
IMAGE_PATH = os.path.sep.join([IMAGE_DIR, args["image"]])
image = cv2.imread(IMAGE_PATH)
(H, W) = image.shape[:2]
RESPONSE['resolution'] = {'width': W, 'height': H}
